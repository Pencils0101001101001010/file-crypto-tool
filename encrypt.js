...
if (filePath === "help" || filePath === undefined) {
  return console.log(
    "To encrypt a file you should run the following command: \n node encrypt.js (absolute path)/fileToEncrypt.fileFormat nameOfSavedFile",
  );
} else if (savedEncryptedFile === undefined) {
  return console.log("Please provide a name for the file to be saved as. ");
}
